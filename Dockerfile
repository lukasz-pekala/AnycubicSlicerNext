...
# Set this so that Anycubic Slicer doesn't complain about
# the CA cert path on every startup
ENV SSL_CERT_FILE=/etc/ssl/certs/ca-certificates.crt

COPY ./ AnycubicSlicer

WORKDIR AnycubicSlicer
...
# It's easier to run Anycubic Slicer as the same username,
...
ENTRYPOINT ["/AnycubicSlicer/build/package/bin/anycubic-slicer"]
