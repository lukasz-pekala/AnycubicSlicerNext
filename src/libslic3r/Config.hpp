...
// When parsing a configuration value, if the old_value is not understood by this AnycubicSlicer version,
// it is being substituted with some default value that this AnycubicSlicer could work with.
