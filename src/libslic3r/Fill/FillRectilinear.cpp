...
// Anycubic: Replaced with FillMonotonicLines from Prusa slicer. Moved gap fill algorithm to
...
/*void FillMonotonicLineWGapFill::fill_surface_extrusion(const Surface* surface, const FillParams& params, ExtrusionEntitiesPtr& out)
{
    ...
    // Anycubic: The above causes pockmarks in top layer surfaces with a properly calibrated printer with PA and EM tuned.
