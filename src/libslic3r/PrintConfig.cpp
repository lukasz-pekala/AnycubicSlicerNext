...
void PrintConfigDef::init_common_params()
{
    ...
    def->tooltip = L("AnycubicSlicerNext can upload G-code files to a printer host. This field should contain "
...
void PrintConfigDef::init_fff_params()
{
    ...
    def->tooltip = L(
        ...
        "set appropriately. AnycubicSlicerNext ensures that adaptive_bed_mesh_min/adaptive_bed_mesh_max values do not exceed these min/max "
    ...
    */
    ...
    def->tooltip = L("After a tool change, the exact position of the newly loaded filament inside "
                     ...
                     "Before purging the print head into an infill or a sacrificial object, AnycubicSlicerNext will always prime "
    ...
    def->tooltip = L("Connect an infill line to an internal perimeter with a short segment of an additional perimeter. "
                     ...
                     "AnycubicSlicerNext tries to connect two close infill lines to a short perimeter segment. If no such perimeter segment "
    ...
    def->tooltip = L("AnycubicSlicerNext can upload G-code files to a printer host. This field must contain "
    ...
    def->tooltip = L("If you want to process the output G-code through custom scripts, "
                   ...
                   "and they can access the AnycubicSlicerNext config settings by reading environment variables.");
    def->gui_flags = "serialized";
    def->multiline = true;
    def->full_width = true;
    def->height = 6;
    ...
    def->tooltip = L("To reduce the waiting time after tool change, AnycubicSlicerNext can preheat the next tool while the current tool is still in use. "
                     "This setting specifies the time in seconds to preheat the next tool. AnycubicSlicerNext will insert a M104 command to preheat the tool in advance.");
    def->sidetext = "s";	// seconds, don't need translation
    def->min = 0;
    def->max = 120;
    def->mode = comAdvanced;
...
ReadWriteSlicingStatesConfigDef::ReadWriteSlicingStatesConfigDef()
{
    ...
    def->tooltip = L("Position of the extruder at the beginning of the custom G-code block. If the custom G-code travels somewhere else, "
                     "it should write to this variable so AnycubicSlicerNext knows where it travels from when it gets control back.");
    ...
    def->tooltip = L("Retraction state at the beginning of the custom G-code block. If the custom G-code moves the extruder axis, "
                     "it should write to this variable so AnycubicSlicerNext de-retracts correctly when it gets control back.");
