...
file(GLOB_RECURSE gen_embed_all_file ${CMAKE_CURRENT_LIST_DIR}/*.xrc)
gen_embed(gen_embed_all_file ${CMAKE_CURRENT_BINARY_DIR}/embed FILES ${gen_embed_all_file})
...
file(GLOB_RECURSE DOWNLOADER_IMPL_SRC ${CMAKE_CURRENT_LIST_DIR}/detail/impl/*.cpp ${CMAKE_CURRENT_LIST_DIR}/detail/impl/*.hpp ${CMAKE_CURRENT_BINARY_DIR}/embed/*.cpp)
...
target_compile_definitions(downloader_impl PRIVATE ENABLE_LOG_CHECK_ARGS=1 ENABLE_STRACE=1 FMT_HEADER_ONLY=1 MODULE_NAME="MainApp"  wxDEBUG_LEVEL=0 USING_EMBED)
target_compile_features(downloader_impl PRIVATE cxx_std_20)
target_include_directories(downloader_impl PRIVATE ${Boost_INCLUDE_DIRS} ${CMAKE_CURRENT_BINARY_DIR}/embed)
target_link_libraries(${CURRENT_TARGET} PRIVATE downloader_impl)