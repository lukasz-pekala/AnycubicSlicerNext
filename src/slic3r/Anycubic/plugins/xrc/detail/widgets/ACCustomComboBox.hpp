#ifndef slic3r_GUI_ACCustomComboBox_hpp_
#define slic3r_GUI_ACCustomComboBox_hpp_
...
class ACCustomComboBox : public wxWindowWithItems<TextInput, wxItemContainer>
{
    ...
    ACCustomDropDown drop;
    bool     drop_down = false;
    bool     text_off = false;

public:
    ACCustomComboBox(wxWindow*       parent,
                     wxWindowID      id,
    ...
    ACCustomDropDown& GetDropDown() { return drop; }
...
public:
    ...
    void     SetShowTextIco(bool show = false);
    void     SetStyleInfo(int style);
