...
void ACStaticBox::SetBorderColor(StateColor const &color)
{
    border_color = color;
    state_handler.update_binds();
    Refresh();
...
void ACStaticBox::SetBackgroundColor(StateColor const &color)
{
...
void ACStaticBox::SetBackgroundColor2(StateColor const &color)
{
