...
void AMSMaterialsSetting::create()
{
    ...
    m_btn_bg_green   = StateColor(std::pair<wxColour, int>(wxColour(204, 224, 254), StateColor::Pressed), std::pair<wxColour, int>(wxColour(105, 164, 255), StateColor::Hovered),
...
void AMSMaterialsSetting::create_panel_normal(wxWindow* parent)
{
    ...
    m_readonly_filament->SetBorderColor(StateColor(std::make_pair(0xDBDBDB, (int)StateColor::Focused), std::make_pair(0x3986FF, (int)StateColor::Hovered),
