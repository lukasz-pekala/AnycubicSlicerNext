...
void AuxiliaryPanel::init_tabpanel()
{
    ...
    back_btn->SetTextColor(StateColor (std::pair<wxColour, int>(wxColour("#FDFFFD"), StateColor::Normal))); // Anycubic fixes color change on text. icon stays white color but text changes to black without this
