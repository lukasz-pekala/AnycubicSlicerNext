    ...
    : DPIDialog(parent, id, _L("Connect Printer (LAN)"), pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(204, 224, 254), StateColor::Pressed),
                          std::pair<wxColour, int>(wxColour(105, 164, 255), StateColor::Hovered),
                          std::pair<wxColour, int>(wxColour(57, 134, 255), StateColor::Normal)
        );

    StateColor btn_bd(std::pair<wxColour, int>(wxColour(57, 134, 255), StateColor::Normal));
