...
{
    // Anycubic: truncate long lines(>55 characters), add "..." at the end
...
void GCodeViewer::load_shells(const Print& print, bool initialized, bool force_previewing)
{
    ...
    // Anycubic: disable wipe tower shell
...
void GCodeViewer::render_legend(float &legend_height, int canvas_width, int canvas_height, int right_margin)
{
        ...
        std::function<void()> callback = nullptr)
    {
        ...
        if (callback) {
            ...
            ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(0.22f, 0.53f, 1.0f,  1.00f));
            ...
            if (checkbox) {
                ...
                ImGui::PushStyleColor(ImGuiCol_CheckMark, ImVec4(0.22f, 0.53f, 1.0f, 1.00f));
...
void GCodeViewer::push_combo_style()
{
    ...
    ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(0.22f, 0.53f, 1.0f,  1.00f));
    ImGui::PushStyleColor(ImGuiCol_HeaderHovered, ImVec4(0.22f, 0.53f, 1.0f,  0.0f));
