...
static const ImU32 BRAND_COLOR            = IM_COL32(57, 134, 255, 255);
...
bool IMSlider::render(int canvas_width, int canvas_height)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_::ImGuiCol_Text, ImGuiWrapper::COL_ORCA); // Anycubic: Use Anycubic color for slider value text
