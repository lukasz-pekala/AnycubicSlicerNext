	...
	, msg(msg)
{
	...
	logo->SetBitmap(create_scaled_bitmap("AnycubicSlicer_192px_grayscale.png", this, monospaced_font ? 48 : /*1*/84));
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        ...
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try Anycubic Slicer Beta, you may click to"));
