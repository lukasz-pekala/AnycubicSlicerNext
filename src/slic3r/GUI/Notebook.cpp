...
#ifdef __APPLE__
    default_btn_bg = wxColour("#434343"); // Gradient #414B4E
#else
    default_btn_bg = wxColour("#434343"); // Gradient #414B4E
#endif
...
void ButtonsListCtrl::OnPaint(wxPaintEvent&)
{
    ...
    wxColour default_btn_bg("#434343"); // Gradient #414B4E
...
void ButtonsListCtrl::SetSelection(int sel)
{
    ...
    wxColour selected_btn_bg("#3986FF");    // Gradient #3986FF
    if (m_selection >= 0) {
        StateColor bg_color = StateColor(
        std::pair{wxColour(107, 107, 107), (int) StateColor::Hovered},
        std::pair{wxColour(67, 67, 67), (int) StateColor::Normal});
    ...
    StateColor bg_color = StateColor(
        std::pair{wxColour(57, 134, 255), (int) StateColor::Hovered},
        std::pair{wxColour(57, 134, 255), (int) StateColor::Normal});
    m_pageButtons[m_selection]->SetBackgroundColor(bg_color);
            ...
            long style)
{
    ...
    Slic3r::GUI::wxGetApp().add_anycubic_window(wxASCII_STR("bookctrl"), m_bookctrl);
