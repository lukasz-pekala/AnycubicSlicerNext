...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour(204, 224, 254), StateColor::Pressed),
...
{
    std::string icon_path = (boost::format("%1%/images/AnycubicSlicerTitle.ico") % Slic3r::resources_dir()).str();
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(204, 224, 254), StateColor::Pressed), std::pair<wxColour, int>(wxColour(105, 164, 255), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(57, 134, 255), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(57, 134, 255), StateColor::Normal));
