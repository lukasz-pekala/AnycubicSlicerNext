    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_ams_backup_tip->SetForegroundColour(wxColour(0x3986FF));
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(204, 224, 254), StateColor::Pressed), std::pair<wxColour, int>(wxColour(105, 164, 255), StateColor::Hovered),
    ...
    m_statictext_finish->SetForegroundColour(wxColour(57, 134, 255));
    ...
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Modifying the device name"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(204, 224, 254), StateColor::Pressed), std::pair<wxColour, int>(wxColour(57, 134, 255), StateColor::Normal));
    m_button_confirm->SetBackgroundColor(btn_bg_green);
    m_button_confirm->SetBorderColor(wxColour(57, 134, 255));
