...
static wxColour BORDER_HOVER_COL = wxColour(57, 134, 255);

const static wxColour TAB_BUTTON_BG    = wxColour("#FEFFFF");
const static wxColour TAB_BUTTON_SEL   = wxColour("#BFE1DE"); // Anycubic
    ...
    , text_color(*wxBLACK)
{
    ...
    border_color = StateColor(
        std::make_pair(TAB_BUTTON_SEL, (int) StateColor::Checked), // Anycubic use same color for border to prevent 1px blank border
