    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(204, 224, 254), StateColor::Pressed);
    border_color.append(wxColour(105, 164, 255), StateColor::Hovered);
    border_color.append(0x3986FF, StateColor::Normal);
    ...
    background_color.append(wxColour(204, 224, 254), StateColor::Pressed);
    background_color.append(wxColour(105, 164, 255), StateColor::Hovered);
    background_color.append(0x3986FF, StateColor::Normal);
    background_color.setTakeFocusedAsHovered(false);

    SetBottomColour(wxColour("#434343"));
