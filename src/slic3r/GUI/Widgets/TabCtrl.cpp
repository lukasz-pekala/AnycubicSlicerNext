                     ...
                     void * clientData)
{
    ...
    wxClientDC dc(this); // ANYCUBIC calculate tab width from bold font to prevent tab movements on tab change
...
void TabCtrl::doRender(wxDC& dc)
{
    ...
    wxColour c("#3986FF"); // Anycubic selected tab underline stroke color
    dc.SetPen(wxPen(c, 1));
    dc.SetBrush(c);
